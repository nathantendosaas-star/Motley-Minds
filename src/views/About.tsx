...
export default function About() {
  ...
  return (
    <div className="w-full pt-20 bg-off-white">
      <Helmet>
        <title>About | Motley Minds</title>
        <meta name="description" content="Motley Minds is a creative denim fashion brand born from the desire to reconstruct the ordinary into the extraordinary." />
      </Helmet>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
            ...
            >
              <motion.div style={{ y: craftY }} className="absolute inset-[-10%] w-[120%] h-[120%]">
                <img src="/10.jpeg" alt="Sewing Denim" className="w-full h-full object-cover rounded-sm" />
              </motion.div>
            </motion.div>
            <motion.div 
              initial={{ opacity: 0, x: 20 }}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center flex-col-reverse md:flex-row-reverse">
            ...
            >
              <motion.div style={{ y: identityY }} className="absolute inset-[-10%] w-[120%] h-[120%]">
                <img src="/4.jpeg" alt="Creative Identity" className="w-full h-full object-cover rounded-sm" />
              </motion.div>
            </motion.div>
            <motion.div 
              initial={{ opacity: 0, x: -20 }}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="relative w-full max-w-4xl mx-auto aspect-[21/9] shadow-xl overflow-hidden border border-silver-rivet/30 rounded-sm">
            <motion.div style={{ y: materialsY }} className="absolute inset-[-20%] w-[140%] h-[140%]">
              <img src="/3.jpeg" alt="Rolled Denim Fabric" className="w-full h-full object-cover" />
            </motion.div>
          </div>
        </div>
      </section>
