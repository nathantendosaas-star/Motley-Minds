      ...
      <section ref={heroRef} className="relative h-screen w-full flex flex-col lg:flex-row items-center justify-center overflow-hidden">
        ...
        <div className="absolute left-0 top-0 w-full lg:w-1/2 h-auto lg:h-full flex flex-col justify-start lg:justify-center px-6 lg:px-12 xl:px-24 z-20 pt-28 lg:pt-0">
          <div className="max-w-md text-center lg:text-left mx-auto lg:mx-0 bg-white/50 lg:bg-transparent p-4 lg:p-0 rounded-lg backdrop-blur-sm lg:backdrop-blur-none flex flex-col items-center lg:items-start gap-4">
            <Link href="/shop" className="inline-block bg-indigo-deep text-off-white px-8 py-4 text-[10px] lg:text-xs font-bold uppercase tracking-widest hover:bg-indigo-deep/90 transition-colors relative group rounded-sm shadow-lg w-full lg:w-auto">
            ...
            <Link href="/lookbook" className="inline-block bg-transparent border border-raw-black text-raw-black px-8 py-4 text-[10px] lg:text-xs font-bold uppercase tracking-widest hover:bg-raw-black hover:text-white transition-colors relative group rounded-sm w-full lg:w-auto shadow-lg backdrop-blur-sm">
        ...
        <div className="hidden lg:flex absolute left-[5%] xl:left-[10%] top-[30%] z-20 bg-white p-4 shadow-xl items-center gap-4 rounded-sm origin-left">
          <div className="w-16 h-16 relative bg-light-stone/20">
            <Image src="/8.jpeg" alt="Jacket" fill className="object-cover" />
          </div>
          <div>
        ...
        <div className="hidden lg:flex absolute right-[5%] xl:right-[15%] top-[25%] z-20 bg-white/10 backdrop-blur-md p-4 shadow-xl items-center gap-4 rounded-sm border border-white/20 origin-right">
          <div className="w-16 h-16 relative bg-white">
            <Image src="/2.jpeg" alt="Top" fill className="object-cover" />
          </div>
          <div>
        ...
        <div className="hidden lg:flex absolute right-[20%] xl:right-[30%] bottom-[20%] z-20 bg-white/10 backdrop-blur-md p-4 shadow-xl items-center gap-4 rounded-sm border border-white/20 origin-right">
          <div className="w-16 h-16 relative bg-white">
            <Image src="/14.jpeg" alt="Skirt" fill className="object-cover" />
          </div>
          <div>
        ...
        <div className="hidden lg:flex absolute right-0 bottom-0 w-1/3 h-[30vh] gap-4 p-8 z-20 items-end justify-end">
          ...
          <div className="w-32 h-40 bg-white p-2 shadow-lg">
            <div className="relative w-full h-full">
              <Image src="/13.jpeg" alt="Model" fill className="object-cover" />
            </div>
          </div>
          <div className="w-32 h-40 bg-white p-2 shadow-lg">
            <div className="relative w-full h-full">
              <Image src="/17.jpeg" alt="Model" fill className="object-cover" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 bg-off-white denim-texture-light relative">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-end mb-12">
            ...
            <Link href="/shop" className="text-sm font-bold uppercase tracking-widest text-indigo-deep hover:text-washed-blue pb-1 border-b border-dashed border-faded-stitch">View All</Link>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            >
              <div className="relative aspect-[3/4] overflow-hidden bg-light-stone mb-4 shadow-md border border-silver-rivet/30 rounded-sm">
                <Image src="/8.jpeg" alt="Denim Jackets" fill className="object-cover transition-transform duration-700 group-hover:scale-105" />
            ...
            >
              <div className="relative aspect-[3/4] overflow-hidden bg-light-stone mb-4 shadow-md border border-silver-rivet/30 rounded-sm">
                <Image src="/1.jpeg" alt="Tote Bags" fill className="object-cover transition-transform duration-700 group-hover:scale-105" />
                <div className="absolute inset-0 bg-raw-black/10 group-hover:bg-transparent transition-colors duration-500" />
              </div>
            ...
            >
              <div className="relative aspect-[3/4] overflow-hidden bg-light-stone mb-4 shadow-md border border-silver-rivet/30 rounded-sm">
                <Image src="/17.jpeg" alt="Crossbody Bags" fill className="object-cover transition-transform duration-700 group-hover:scale-105" />
                <div className="absolute inset-0 bg-raw-black/10 group-hover:bg-transparent transition-colors duration-500" />
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center gap-16">
          ...
          >
            ...
            <motion.div style={{ y: storyImageY }} className="absolute inset-[-10%] w-[120%] h-[120%]">
              <Image src="/4.jpeg" alt="Craftsmanship" fill className="object-cover z-10 relative border-4 border-raw-black rounded-sm" />
            </motion.div>
          </motion.div>
          <motion.div 
            initial={{ opacity: 0, x: 20 }}
          ...
          >
            ...
            <Link href="/about" className="inline-block bg-transparent border border-off-white text-off-white px-8 py-4 font-bold uppercase tracking-widest text-sm hover:bg-off-white hover:text-indigo-deep transition-colors relative group rounded-md">
          ...
          <div className="flex flex-col md:flex-row gap-16">
            ...
            <div className="w-full md:w-1/3">
              <div ref={lookbookTextRef} className="md:h-screen flex flex-col justify-center">
                ...
                <div>
                  <Link href="/lookbook" className="inline-block bg-indigo-deep text-off-white px-8 py-4 font-bold uppercase tracking-widest text-sm hover:bg-raw-black transition-colors shadow-md relative group rounded-md">
            ...
            <div className="w-full md:w-2/3 grid grid-cols-1 sm:grid-cols-2 gap-8 md:pt-[20vh] md:pb-[20vh]">
              <div className="lookbook-image relative aspect-[3/4] overflow-hidden bg-light-stone border border-silver-rivet/30 shadow-lg rounded-sm">
                <Image src="/25.jpeg" alt="Lookbook 1" fill className="object-cover" />
              </div>
              <div className="lookbook-image relative aspect-[3/4] overflow-hidden bg-light-stone border border-silver-rivet/30 shadow-lg rounded-sm sm:mt-24">
                <Image src="/19.jpeg" alt="Lookbook 2" fill className="object-cover" />
              </div>
              <div className="lookbook-image relative aspect-[3/4] overflow-hidden bg-light-stone border border-silver-rivet/30 shadow-lg rounded-sm">
                <Image src="/24.jpeg" alt="Lookbook 3" fill className="object-cover" />
              </div>
              <div className="lookbook-image relative aspect-[3/4] overflow-hidden bg-light-stone border border-silver-rivet/30 shadow-lg rounded-sm sm:mt-24">
                <Image src="/28.jpeg" alt="Lookbook 4" fill className="object-cover" />
              </div>
            </div>
